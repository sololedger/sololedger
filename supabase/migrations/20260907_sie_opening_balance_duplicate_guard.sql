-- supabase/migrations/20260907_sie_opening_balance_duplicate_guard.sql
--
-- Bygger på den live-version av public.import_sie_batch(jsonb) som verifierades
-- direkt i Supabase 2026-09-07.
--
-- Funktionell ändring:
--   * separat dubblettskydd för ingående balans (#IB) per användare/räkenskapsår
--   * legacy-IB (source='sie_import' + description='Öppningsbalans') räknas också
--   * transaktionslås skyddar även mot två samtidiga importer
--   * SQLSTATE P2001 låter klienten skilja IB-konflikt från samma filhash
--
