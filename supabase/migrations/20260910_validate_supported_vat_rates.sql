-- H1: enforce supported VAT rates server-side for all bookings.
-- Safe to run once on the current database.
-- Keeps existing behavior for 0, 6, 12 and 25 percent VAT.
-- Blocks unsupported rates (for example 7%) before any transaction is created.
